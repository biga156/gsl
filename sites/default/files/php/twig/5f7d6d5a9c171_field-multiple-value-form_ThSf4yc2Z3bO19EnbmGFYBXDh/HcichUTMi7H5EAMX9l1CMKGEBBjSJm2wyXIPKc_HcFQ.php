...
class __TwigTemplate_358f3271a3fc9d0246e72a0a0080531f669ca0b6df80501434e7a7f3da26d255 extends \Twig\Template
{
    ...
    ";
            ...
            if ($this->getAttribute(($context["description"] ?? null), "content", [])) {
                // line 26
                echo "      <div";
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["description"] ?? null), "attributes", []), "addClass", [0 => "w3-small description"], "method")), "html", null, true);
                echo " >";
...
";
  ...
  ";
    ...
    {
        return new Source("", "themes/d8w3css/templates/form/field-multiple-value-form.html.twig", "C:\\wamp64\\www\\drupal_gsl\\themes\\d8w3css\\templates\\form\\field-multiple-value-form.html.twig");
    }
}
